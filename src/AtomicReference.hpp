#ifndef ATOMICREFERENCE_HPP
#define ATOMICREFERENCE_HPP
...
/**
 * Note that this doesn't need the lock as it doesn't matter whether it sees a new or an old version of the value.  Even if compareAndSet is updating it won't matter whether this method sees the old value or the new value.
 */
template <class T>
